...
<html>
  <head>
    ...
    <meta name="description" content="Subida de archivos y herramienta de edicion">
...
Google+: <input type="text" style="width: 433px;" id="googleAutor" name="googleAutor" value="https://plus.google.com/105433436614688812196?rel=author" size="250" maxlength="570"/><br><br>	
...
{% } %}
	...
	<div id="copyright">
		...
		<div class="container">
			...
			<div class="span12">
				<p>
					&copy; <a href="/">CH</a><i style="margin-top: -18px;" class="ico-color ico-sun"></i>
				</p>
			</div>
